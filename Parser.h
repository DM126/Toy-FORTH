...
private:
	...
	int readStringLiteral(const std::string& str, const int i);
	...
	//Returns the ending index within the line.
	int readSingleToken(const std::string& line, const int i);

	//Returns true if a comment begins at the specified index of the line
	bool isComment(const std::string& line, const int i) const;

	//Returns true if the specified index is the beginning of a string literal (.")
	bool isStringLiteral(const std::string& line, const int i) const;

	//Returns true if the current character is a digit or a negative sign
	//preceding a digit.
	bool isStartOfInt(const std::string& line, const int i) const;
	...
	bool equalsTwoChars(const std::string& line, const int i, const char char1, const char char2) const;

	//Returns true if the index is the last character on the line
	bool isEndOfLine(const std::string& line, const int i) const;
